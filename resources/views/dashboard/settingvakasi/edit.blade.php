...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Edit Setting Vakasi lalala</h1>
</div>
<div class="col-lg-12">
    <form method="POST" action="/dashboard/settingvakasis/{{ $data->id }}">
        @csrf
        @method('put')
        <div class="row">
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('kode_setting') is-invalid @enderror" name="kode_setting"
                        ...
                        value="{{ old('kode_setting', $data->kode_setting) }}" disabled>
                    @error('kode_setting')
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('honor_soal') is-invalid @enderror" name="honor_soal"
                        id="honor_soal" placeholder="honor_soal" value="{{ old('honor_soal', $data->honor_soal) }}"
                        required>
                    @error('honor_soal')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('honor_pembuat_soal') is-invalid @enderror"
                        ...
                        value="{{ old('honor_pembuat_soal', $data->honor_pembuat_soal) }}">
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('honor_pengawas') is-invalid @enderror"
                        ...
                        value="{{ old('honor_pengawas', $data->honor_pengawas) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('honor_soal_lewat') is-invalid @enderror"
                        ...
                        value="{{ old('honor_soal_lewat', $data->honor_soal_lewat) }}">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="is_active">
                        <option value="{{ $data->is_active }}" selected>{{ $data->is_active }}</option>
